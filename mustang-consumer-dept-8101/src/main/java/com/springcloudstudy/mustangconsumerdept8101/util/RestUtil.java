package com.springcloudstudy.mustangconsumerdept8101.util;
...
public class RestUtil {
    ...
    public static String EncoderByMd5(String str){
        ...
        try {
            ...
            // 加密后的字符串
            return Base64.encodeBase64String(md5.digest(str.getBytes("utf-8"))).toUpperCase();
